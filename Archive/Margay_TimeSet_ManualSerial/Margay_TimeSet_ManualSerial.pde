/**
  ...
  * THIS IS FOR MANUAL OPERATION ONLY! 
  * See standard TimeSet program for automatic serial port identification 
  *
...
static int SerialPortNum = 0;  //USER DEFINABLE
...
void setup() 
{
  ...
  String[] SerialList = Serial.list(); //Get list array
